...
*/
void DLMSSha1::Transform(unsigned long *block, unsigned int *digest, unsigned int *transforms)
{
...
void DLMSSha1::Update(ByteBuffer& data, unsigned int *digest, unsigned int *transforms)
{
    unsigned int pos;
...
int DLMSSha1::Final(ByteBuffer& data, unsigned int *digest, unsigned int *transforms, ByteBuffer& reply)
{
    int pos;
...
int DLMSSha1::Encrypt(ByteBuffer& data, ByteBuffer& result)
{
