...
void DLMSSha256::Transform(unsigned int *h, const unsigned char *message, unsigned int block_nb)
{
    unsigned int w[64];
    unsigned int wv[8];
    unsigned int t1, t2;
...
int DLMSSha256::Update(unsigned int *h, unsigned char *block, ByteBuffer&  data, unsigned int *len, unsigned int *totalLen)
{
...
int DLMSSha256::Final(unsigned int *h, unsigned char *block, unsigned char *digest, unsigned int len, unsigned int totalLen)
{
    unsigned int block_nb;
    unsigned int pm_len;
    unsigned int len_b;
...
int DLMSSha256::Encrypt(ByteBuffer& data, ByteBuffer& digest)
{
