#ifndef DLMS_Prime_NbOfdmPlc_Mac_Functional_Parameters_H
#define DLMS_Prime_NbOfdmPlc_Mac_Functional_Parameters_H
...
class DLMSPrimeNbOfdmPlcMacFunctionalParameters : public DLMSObject
{
    /*
...
public:
    //Constructor.
    DLMSPrimeNbOfdmPlcMacFunctionalParameters();

    //SN Constructor.
    DLMSPrimeNbOfdmPlcMacFunctionalParameters(std::string ln, unsigned short sn);

    //LN Constructor.
    DLMSPrimeNbOfdmPlcMacFunctionalParameters(std::string ln);
